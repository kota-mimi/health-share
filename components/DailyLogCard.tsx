...
export const DailyLogCard: React.FC<DailyLogCardProps> = ({ 
  ...
  return (
    <div 
      id={id}
      className={`w-[280px] h-[450px] sm:w-[340px] sm:h-[550px] ${!customImage ? bgClass : 'bg-black'} relative overflow-hidden flex flex-col select-none shadow-2xl transition-colors duration-500`}
      style={{
